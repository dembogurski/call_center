...
class Entidades {
    ...
    private  $items = [array("column_name"=>"cod_ent","nullable"=>"NO","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Cod Ent=>","titulo_listado"=>"Cod Ent","type"=>"number","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Auto","default"=>"","pk"=>"PRI","extra"=>"auto_increment"),array("column_name"=>"tipo_doc","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo Doc=>","titulo_listado"=>"Tipo Doc","type"=>"select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"RUC=>RUC,CI=>CI,Otro=>Otro","pk"=>"","extra"=>""),array("column_name"=>"ci_ruc","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"RUC\/Doc=>","titulo_listado"=>"RUC\/Doc","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),array("column_name"=>"nombre","nullable"=>"YES","data_type"=>"varchar","max_length"=>"60","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Nombre=>","titulo_listado"=>"Nombre","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),array("column_name"=>"tel","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tel=>","titulo_listado"=>"Tel","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),array("column_name"=>"email","nullable"=>"YES","data_type"=>"varchar","max_length"=>"40","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Email=>","titulo_listado"=>"Email","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),array("column_name"=>"codigo_pais","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Codigo Pais=>","titulo_listado"=>"","type"=>"db_select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"paises=>codigo_pais,nombre","pk"=>"MUL","extra"=>""),array("column_name"=>"cod_depart","nullable"=>"NO","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Departamento=>","titulo_listado"=>"","type"=>"db_select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"departamentos=>cod_depart,nombre_depar","pk"=>"","extra"=>""),array("column_name"=>"dist_num","nullable"=>"NO","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Dist Num=>","titulo_listado"=>"","type"=>"db_select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"distritos=>dist_num,nombre","pk"=>"","extra"=>""),array("column_name"=>"ciudad","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Ciudad=>","titulo_listado"=>"","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),array("column_name"=>"dir","nullable"=>"YES","data_type"=>"varchar","max_length"=>"60","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Dir=>","titulo_listado"=>"","type"=>"textarea","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),array("column_name"=>"tipo","nullable"=>"YES","data_type"=>"varchar","max_length"=>"16","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo=>","titulo_listado"=>"","type"=>"select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"C1=>V1,C2=>V2","pk"=>"","extra"=>""),array("column_name"=>"fecha_reg","nullable"=>"YES","data_type"=>"date","max_length"=>"","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Fecha Reg=>","titulo_listado"=>"","type"=>"date","required"=>"","inline"=>"false","editable"=>"No","insert"=>"No","default"=>"","pk"=>"","extra"=>""),array("column_name"=>"estado","nullable"=>"YES","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Estado=>","titulo_listado"=>"Estado","type"=>"select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Auto","default"=>"Activo=>Activo,Inactivo=>Inactivo","pk"=>"","extra"=>"")];    
    private $primary_key = 'cod_ent';
    private $limit = 100;
    ...
    function main() {
        ...
        $t = new Y_Template("Entidades.html");
        $t->Show("headers");
             ...
             if($insert === 'Yes'){
                ...
                if($type == "db_select"){
                    ...
                    if($tablename == "distritos"){
                        $query = "SELECT $columns FROM distritos d, departamentos e WHERE  d.cod_depart = e.cod_depart AND e.estado = 'Activo'";
                    }
                    $tmp_con->Query($query);
    ...
    function getDistritos(){
        $dep = $_REQUEST['dep'];   
        $fn = new Functions();
        echo json_encode($fn->getResultArray("SELECT dist_num, nombre FROM distritos WHERE codigo_pais = 'PY' AND cod_depart = '$dep'"));
    }
