...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="img/call_center.ico">
    <link rel="shortcut icon" href="img/call_center.ico" type="image/x-icon">
    <link rel="shortcut icon" href="img/call_center.png" />
...
<body>
    <div> 
        <div style="text-align: center" > <img src="img/logo_call_center.png" width="424px" height="98" alt="Call Center"> </div>
